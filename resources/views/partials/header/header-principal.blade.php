    ...
    <ul class="nav navbar-nav">
        <li class="nav-item">
            <a class="navbar-brand" href="#">
                <img class="logo-header" width="110" src="/images/logo-como-suena-venezuela.png" alt="" style="width: 14rem">
            </a>
        </li>
    </ul>
</div>
...
<div class="navbar-header d-xl-block d-none">
    <ul class="nav navbar-nav">
        <li class="nav-item">
            <a class="navbar-brand" href="#">
                <img class="{{ auth()->user()->roles[0]->name == "Aspirante" ? 'logo-header-aspirant' : 'logo-header'}}" width="100" src="{{ env('URL_IMG_LOGO') }}" alt="">
            </a>
        </li>
    </ul>
</div>
