        ...
        <div class="content-body">
            ...
            <div class="auth-wrapper auth-v1 px-2">
                <div class="auth-inner py-2">
                    <!-- Forgot Password v1 -->
                    <div class="card mb-0">
                        <a href="#" class="brand-logo p-2 bg-black-como-suena-venezuela" style="margin-top: -2rem">
                            <img class="" width="250" height="100" src="/images/logo-como-suena-venezuela.png" alt="">
                        </a>
                        <div class="card-body">
                            ...
                            <form class="auth-forgot-password-form mt-2" method="POST"
                                ...
                                @enderror
                                <button class="btn btn-primary btn-block pt-1" type="submit" tabindex="2">Recuperar
                                    Contraseña
                                </button>
                            </form>
