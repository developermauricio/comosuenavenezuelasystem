...
<div id="app">
    ...
    <!-- BEGIN: Header-->
    <nav class="header-navbar bg-black-como-suena-venezuela navbar-expand-lg navbar navbar-fixed align-items-center navbar-shadow navbar-brand-center"
    ...
    <footer class="footer footer-light">
        ...
        <div id="carousel-pause" class="carousel slide d-lg-none d-md-none text-center" data-ride="carousel"
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img class="img-fluid" width="200" src="/images/sponsors/sponsor-banner.png" alt="First slide"/>
                </div>
                <div class="carousel-item">
                    <img class="img-fluid" width="200" src="/images/sponsors/sponsor-banner.png" alt="Second slide"/>
                </div>
                <div class="carousel-item">
                    <img class="img-fluid" width="200" src="/images/sponsors/sponsor-banner.png" alt="Third slide"/>
                </div>
            </div>
        ...
        <div class="row footer-logos">
            <div class="col-12 col-md-1 col-lg-2 mt-2">
                <img class="" width="180" src="/images/sponsors/sponsor-banner.png" alt="">
            </div>
            <div class="col-12 col-md-1 col-lg-2 mt-2">
                <img class="" width="180" src="/images/sponsors/sponsor-banner.png" alt="">
            </div>
        ...
        <span class="float-md-right d-none d-md-block" style="font-size: 0.8rem !important; margin-top: 1rem;">
            ComoSuenaVenezuela 2023 © Todos los derechos reservados.
        </span>
    </footer>
